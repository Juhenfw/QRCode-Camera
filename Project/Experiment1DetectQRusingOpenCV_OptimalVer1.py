...
while (cv2.waitKey(1) & 0xFF) != 27:
    try:
        ...
        if frame_count % 1 == 0:
            ...
            _, otsu_thresh = cv2.threshold(gray,81,255,cv2.THRESH_TOZERO_INV+cv2.THRESH_OTSU)
            decoded_text, points, _ = qr_code_detector.detectAndDecode(otsu_thresh)
            ...
            if points is not None:
                ...
                for j in range(len(points)):
                    ...
                    cv2.line(frame, pt1, pt2, (0, 255, 0), 2)  # Warna Kotak
        ...
        otsu_thresh = cv2.resize(otsu_thresh, (640, 480))

        cv2.imshow("Press ESC to end", otsu_thresh)
